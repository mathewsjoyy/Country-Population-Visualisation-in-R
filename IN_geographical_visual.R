...
dataset <- st_read("R_Geographical_Mapping_Project/kontur_population_IN_20220630.gpkg")
...
raster <- st_rasterize(dataset,
                       nx = 1385,  # Had to hard code value  for nx/ny from above 2 nx/ny_value formulas
...
render_camera(phi = 60, zoom = .6)

# Render plot in higher quality, and edit attributes such as lighting
outfile <- "R_Geographical_Mapping_Project/plot1.png"
